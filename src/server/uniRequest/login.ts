...
export const login = (username: string, password: string) => {
    return uni.request({
        url: `${ENV_CONFIG.BASE_API}/auth/login`,
        data: {
            username, password
        },
        method: `POST`,
...
export const getUser = () => {
    return uni.request({
        url: `${ENV_CONFIG.BASE_API}/auth/profile`,
        method: `GET`,
...
export const getTokenTiezi = () => {
    return uni.request({
        url: `${ENV_CONFIG.BASE_API}/auth/tokenTiezi`,
        method: `GET`,
        header: { Authorization: `Bearer ${uni.getStorageSync(`loginKey`)}` },
        timeout: 5000
    }).then(res => res.data);
...
export const likePost = (user_id: number, post_id: number, code: string) => {
    return uni.request({
        url: `${ENV_CONFIG.BASE_API}/auth/authLike`,
        method: `PUT`,
...
export const isLike = (user_id: number, post_id: number) => {
    return uni.request({
        url: `${ENV_CONFIG.BASE_API}/auth/authIsLike`,
        method: `GET`,
...
export const followTieba = (id: number) => {
    return uni.request({
        url: `${ENV_CONFIG.BASE_API}/auth/authUserTieba`,
        method: `GET`,
        data: { id },
        header: { Authorization: `Bearer ${uni.getStorageSync(`loginKey`)}` },
        timeout: 5000
...
export const isSubscribe = (userId: number, tiebaId: number) => {
    return uni.request({
        url: `${ENV_CONFIG.BASE_API}/auth/isSubscribe`,
        method: `GET`,
        data: { userId, tiebaId },
        header: { Authorization: `Bearer ${uni.getStorageSync(`loginKey`)}` },
        timeout: 5000
...
export const subTieba = (user_id: number, tieba_id: number) => {
    return uni.request({
        url: `${ENV_CONFIG.BASE_API}/auth/followTieba`,
        method: `POST`,
...
export const loginUserPosts = (id: number, page: number, pageSize: number) => {
    return uni.request({
        url: `${ENV_CONFIG.BASE_API}/auth/userPosts`,
        method: `GET`,
        header: { Authorization: `Bearer ${uni.getStorageSync(`loginKey`)}` },
...
export const authUpdateUser = (userInfo: User) => {
    return uni.request({
        url: `${ENV_CONFIG.BASE_API}/auth/authUpdateUser`,
        method: `PUT`,
        header: { Authorization: `Bearer ${uni.getStorageSync(`loginKey`)}` },
        data: { userInfo },
        timeout: 5000
